      ...
      <div className={styles.about__container}>
        ...
        >
          ...
          >
            ...
            >
              A place to cold plunge with our friends, close to home. When we couldn&apos;t find anything that felt right—affordable, high-quality, and built around community—we decided to create it ourselves. Vital Ice was built to bridge the gap between high-performance recovery and everyday accessibility.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
