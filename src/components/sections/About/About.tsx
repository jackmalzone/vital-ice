          ...
          >
            <motion.div className={styles.about__item} variants={fadeInUp}>
              ...
              <p className={styles.about__itemText}>
                Accelerate your recovery with our state-of-the-art cold therapy treatments. 
                Reduce inflammation, relieve pain, and enhance your body's natural healing process.
              </p>
            </motion.div>
            ...
            <motion.div className={styles.about__item} variants={fadeInUp}>
              ...
              <p className={styles.about__itemText}>
                Boost your overall wellness through controlled cold exposure. 
                Improve circulation, strengthen your immune system, and increase energy levels.
              </p>
            </motion.div>
            ...
            <motion.div className={styles.about__item} variants={fadeInUp}>
              ...
              <p className={styles.about__itemText}>
                Join a community of like-minded individuals committed to their health and wellness journey. 
