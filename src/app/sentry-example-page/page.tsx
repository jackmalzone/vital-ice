    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="https://seventh-foundry.sentry.io/issues/?project=4509843734265856"
          >
            Issues Page
          </a>
        ...
        <button
          ...
          onClick={() => {
            Sentry.startSpan(
              {
                op: 'test.profiling',
                name: 'Test Profiling Span',
              },
              span => {
                span.setAttribute('test_type', 'profiling');
          ...
          disabled={!isConnected}
        >
          <span>Test Profiling</span>
        </button>

        <button
          type="button"
          onClick={() => {
            // Test browser profiling with intensive work
            Sentry.startSpan(
              {
                op: 'test.browser_profiling',
                name: 'Browser Profiling Test',
              },
              span => {
                span.setAttribute('test_type', 'browser_profiling');
                span.setAttribute(
                  'browser',
                  navigator.userAgent.includes('Chrome') ? 'chrome' : 'other'
                );

                // Simulate intensive work that will be profiled
          ...
          disabled={!isConnected}
        >
          <span>Test Browser Profiling</span>
        </button>
