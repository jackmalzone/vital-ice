...
export const servicesData: Record<string, ServiceData> = {
  'cold-plunge': {
    ...
    subtitle: 'Experience the transformative power of controlled cold exposure for enhanced recovery, mental resilience, and overall wellness',
    description: 'Cold plunge therapy involves immersing your body in cold water (typically 50-60°F) for short periods to trigger a range of physiological responses. This ancient practice has been used for centuries across cultures and is now backed by modern science. At Vital Ice, we provide a safe, controlled environment for cold exposure therapy, combining traditional wisdom with modern technology to deliver optimal results.',
    ...
    process: [
      {
        step: '01',
        title: 'Preparation',
        description: 'Arrive hydrated and remove any metal jewelry. Our staff will explain the session and safety guidelines.'
      },
      {
        step: '02',
        title: 'Session',
        description: 'Enjoy 20-30 minutes in our infrared sauna at 120-140°F, much lower than traditional saunas.'
      },
      {
        step: '03',
        title: 'Hydration',
        description: 'Stay well-hydrated throughout your session and listen to your body\'s signals.'
      },
      {
        step: '04',
        title: 'Cool Down',
        description: 'Gradually cool down and consider pairing with our cold plunge for contrast therapy.'
      }
    ],
    ctaTitle: 'Ready to Experience Infrared Sauna?',
    ctaText: 'Book your session and experience the deep therapeutic benefits of infrared heat therapy'
  },
  'traditional-sauna': {
    id: 'traditional-sauna',
    title: 'Traditional Sauna',
    subtitle: 'Classic Finnish-style sauna experience with dry heat therapy',
    description: 'Experience the authentic Finnish sauna tradition with our traditional dry heat sauna. This time-honored practice uses high temperatures and low humidity to create an intense therapeutic environment. Traditional saunas operate at higher temperatures than infrared, typically 160-200°F, providing a more intense heat experience that has been used for centuries to promote health and wellness.',
    ...
    process: [
      {
        step: '01',
        title: 'Preparation',
        description: 'Shower and arrive hydrated. Remove all jewelry and metal objects before entering.'
      },
      {
        step: '02',
        title: 'Heat Session',
        description: 'Spend 10-15 minutes in the sauna at 160-200°F, listening to your body\'s signals.'
      },
      {
        step: '03',
        title: 'Cool Down',
      ...
      },
      {
        step: '04',
        title: 'Rest',
        description: 'Rest and rehydrate between sessions, typically 2-3 rounds for optimal benefits.'
      }
    ],
    ...
    process: [
      {
        step: '01',
        title: 'Assessment',
        description: 'Our staff will assess your needs and explain the compression therapy process.'
      },
      {
        step: '02',
        title: 'Session',
        description: 'Relax for 20-30 minutes while the compression boots provide rhythmic pressure therapy.'
      },
      {
        step: '03',
        title: 'Monitoring',
        description: 'The system automatically adjusts pressure levels for optimal therapeutic effect.'
      },
      {
        step: '04',
        title: 'Recovery',
  ...
  'red-light-therapy': {
    ...
    process: [
      ...
      },
      {
        step: '02',
        title: 'Treatment',
        description: 'Sit or lie comfortably while the red light penetrates your skin for 10-20 minutes.'
      },
      {
        step: '03',
        title: 'Protection',
